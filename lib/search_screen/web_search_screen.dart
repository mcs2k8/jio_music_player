...
import 'package:music_player/search_screen/web_mini_song_list_widget.dart';
...
class _WebSearchScreenState extends State<WebSearchScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    if (search.isNotEmpty)
      LocalSongManager.instance.searchSongsArtistsAlbums(search);
    return Scaffold(
      appBar: AppBar(
                  ...
                  children: [
                    ...
                    Expanded(
                      ...
                      onSubmitted: (text) async{
                            qqSongs = (await MusicApiClient.qq.search(text, 1))['result'];
                            setState(() {
      ...
      body: Column(
        children: [
          Expanded(
            child: WebMiniSongListWidget(songs: qqSongs,),
          ),
          // Expanded(
