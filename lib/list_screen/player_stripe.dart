...
class _PlayerStripeState extends State<PlayerStripe> {
  ...
  Widget build(BuildContext context) {
    return InkWell(
        ...
        Navigator.push(
            ...
            PageRouteBuilder(
                pageBuilder: (context, animation, secondaryAnimation) =>
                    PlayerPage(playerManager: _playerManager),
                transitionsBuilder:
      ...
      child: ValueListenableBuilder<AudioModel?>(
        valueListenable: _playerManager.currentSongNotifier,
        builder: (_, currentSong, ___) {
          return Container(
              height: 70,
              ...
              child: Row(
                ...
                children: [
                  ...
                  IconButton(
                      onPressed: () {
                        if (!_playerManager.isLastSongNotifier.value){
